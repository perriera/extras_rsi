...
//     system("build/socketpool_server send.txt 127.0.0.1 8080 send.txt upload download &");
//     REQUIRE(system("build/socketpool_client send.txt 127.0.0.1 8080 send.txt upload download ") == 0);
//     REQUIRE(!fs::exists(uploaded_file));
//     REQUIRE(fs::exists(target));
// }
